package ru.trylogic.jetty.server.handler;
...
/**
 * That class was copy-pasted from org.eclipse.jetty.server.handler.ResourceHandler because it can't be extended :(
 * 
 */
public class PostResourceHandler extends HandlerWrapper {
